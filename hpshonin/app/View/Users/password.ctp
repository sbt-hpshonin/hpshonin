...
<?php $this->end(); ?>
		<div class="row-fluid">
			<div class="span12">
				<div class="titlebar">パスワード変更<?php echo $this->Html->link('<i class="icon icon-question-sign icon-white"></i>ヘルプ', '/manual.pdf', array('class'=> 'pull-right' ,'target' => '_blank', "escape" => false)); ?></div>
