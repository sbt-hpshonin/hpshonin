 ...
 *
 */
class BatchNewProjectController extends BatchMtController {
	...
	*/
	...
	public function execute() {
		$this->log(sprintf("MTプロジェクト作成バッチを開始しました。(%d)", $this->id), LOG_INFO);
...
// 		$this->ApprovalMtDb->close();
		...
		$this->log(sprintf("MTプロジェクト作成バッチを終了しました。(%d)", $result), LOG_INFO);
		return $result;
	}
}
?>