...
// App::import("Controller", "BatchEMailNewUser");
 ...
 *
 */
class BatchNewUserController extends BatchMtController {
	...
	*/
	...
	public function execute() {
		$this->log(sprintf("MTユーザー作成バッチを開始しました。(%d)", $this->id), LOG_INFO);
		...
		$this->log(sprintf("MTユーザー作成バッチを終了しました。(%d)", $result), LOG_INFO);
		return $result;
	}
}
?>