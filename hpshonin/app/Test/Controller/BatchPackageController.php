...
*/		
		$this->log('ステージングサイトの切り替え 終了 return true', LOG_DEBUG);
		return true;
	}
...
*/
		$this->log('テスト：ステージング用フォルダを更新 return true', LOG_DEBUG);
		return true;
	}
	...
	protected function sendMailOpenFinish() {
		...
		*/
		$this->log('テスト：公開完了メールを送信 return true', LOG_DEBUG);
		return true;
	}
...
*/
		$this->log('テスト：生きてるパッケージの公開用サイトを再構築 return true', LOG_DEBUG);
		return true;
	}
