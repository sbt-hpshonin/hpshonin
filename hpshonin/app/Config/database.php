...
class DATABASE_CONFIG {
	...
	public $mt_edit_db = array(
		'datasource' => 'Database/Mysql',
		'persistent' => false,
		'host' => AppConstants::MT_EDIT_DB_SERVER,
		'login' => AppConstants::MT_EDIT_DB_USER,
		'password' => AppConstants::MT_EDIT_DB_USER_PASSWORD,
		'database' => AppConstants::MT_EDIT_DB_NAME,
		'prefix' => '',
		'encoding' => 'utf8',
	);
}
